...
#********* Menu for admin only *********
# when above is true and username is equal to "admin"
...
# When user enter "r"
# indented by under the if statement line 35 so that the menu can follow a set of rules
# if user choose "r" the following will take place indented under if if statement 
