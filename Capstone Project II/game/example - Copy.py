...
enemyYPosition1 =  random.randint(0, screen_height - enemy1_width )

enemyYPosition2 =  screen_height
enemyXPosition2 =  random.randint(0, screen_width - enemy2_width )

enemyXPosition3 =  screen_height
enemyYPosition3 =  random.randint(0, screen_width - enemy3_width )
...
while 1: # This is a looping structure that will loop the indented code until you tell it to stop(in the event where you exit the program by quitting). In Python the int 1 has the boolean value of 'true'. In fact numbers greater than 0 also do. 0 on the other hand has a boolean value of false. You can test this out with the bool(...) function to see what boolean value types have. You will learn more about while loop structers later.
    ...
    screen.blit(enemy2, (enemyYPosition2, enemyXPosition2))
  ...
  # After events are checked for in the for loop above and values are set,
    ...
    keys = pygame.key.get_pressed() # This event checks if the user press a key down up right and left.

    if keys[pygame.K_LEFT]:  # Test if the key pressed is the one we want.
        if playerXPosition > 0: # pygame.K_UP represents a keyboard key constant.
            playerXPosition -= 1
    ...
    # Bounding box for the enemy 1,2 and 3:

    enemyBox = pygame.Rect(enemy1.get_rect())
    enemyBox.top = enemyYPosition1
    enemyBox.left = enemyXPosition1

    enemyBox1 = pygame.Rect(enemy2.get_rect())
    enemyBox1.top = enemyXPosition2
    enemyBox1.left = enemyYPosition2

    enemyBox2 = pygame.Rect(enemy3.get_rect())
    enemyBox2.top = enemyYPosition3
    enemyBox2.left = enemyXPosition3
    ...
    elif playerBox.colliderect(enemyBox1):
    ...
    if enemyXPosition1 < 0 - enemy1_width:
    ...
    elif enemyXPosition2 < 0 - enemy2_width:

       print("You win!")
       pygame.quit()
       exit(0)
       
    elif enemyYPosition3 < 0 - enemy3_width:
    ...
    enemyXPosition1 -= 0.10
    enemyXPosition2 -= 0.10
    enemyXPosition3 -= 0.15
    enemyYPosition3 -= 0.30
